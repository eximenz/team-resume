...
const UserCard = ({
    ...
    const isBookMark = useSelector(getUserBookMarkById(userId ? userId : 1));
    const handleSetUserBookMark = () => {
        dispatch(setUserBookMark(Number(userId)));
    };
    ...
    return (
        <div className="col w-auto">
            <div
                ...
                style={{ maxWidth: "24rem", minHeight: "45vh" }}
            >
                <div
                ...
                >
                    <small className="text-muted">
                        {footer + displayDate(currentUser.created)}
                    </small>
                    {!isInProfile && (
                        <div className="d-flex flex-sm-row justify-content-around">
                            ...
                            <button
                                className={`btn ${
                                    isBookMark ? "btn-secondary" : "btn-success"
                                } btn-sm m-3`}
                                onClick={handleSetUserBookMark}
                            >
                                {!isBookMark && (
                                    <svg
                                        ...
                                        height="16"
                                        fill="currentColor"
                                        className="bi bi-arrow-through-heart-fill m-1"
                                        viewBox="0 0 16 16"
                                    >
                                        <path
                                            fillRule="evenodd"
                                ...
                                {isBookMark && (
                                    <svg
                                        ...
                                        height="16"
                                        fill="currentColor"
                                        className="bi bi-arrow-through-heart m-1"
                                        viewBox="0 0 16 16"
                                    >
                                        <path
                                            fillRule="evenodd"
